                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm leading-relaxed">
                            Votre partenaire de confiance pour tous vos besoins de jardinage. Qualite, passion et expertise
                            depuis 2020.
                        </p>
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="#" class="text-green-100 hover:text-white transition">Plantes d'Interieur</a></li>
                            <li><a href="#" class="text-green-100 hover:text-white transition">Plantes d'Exterieur</a></li>
                            <li><a href="#" class="text-green-100 hover:text-white transition">Graines Bio</a></li>
                            <li><a href="#" class="text-green-100 hover:text-white transition">Outils de Jardin</a></li>
                            <li><a href="#" class="text-green-100 hover:text-white transition">Irrigation</a></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <!-- Newsletter -->
                        <div class="mt-6">
                            <p class="text-green-100 text-sm mb-3">Abonnez-vous a notre newsletter</p>
                            <div class="flex">
                ...
                <div class="container mx-auto px-6 py-6">
                    <div class="flex flex-col md:flex-row justify-between items-center">
                        <p class="text-green-100 text-sm mb-4 md:mb-0">
                            2026 Jardin Vert. Tous droits reserves.
                        </p>
                        <div class="flex space-x-6 text-sm">
                            <a href="#" class="text-green-100 hover:text-white transition">Politique de confidentialite</a>
                            <a href="#" class="text-green-100 hover:text-white transition">Conditions d'utilisation</a>
                            <a href="#" class="text-green-100 hover:text-white transition">Mentions legales</a>
                        </div>
                    </div>
                </div>
            </div>
